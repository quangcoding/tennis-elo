  ...
  >
    ...
    >
      ...
      >
        <div class="flex items-center space-x-2">
          ...
          >
            <!-- Users Icon -->
            <svg
              class="w-5 h-5 text-slate-950 stroke-current"
              fill="none"
              stroke-width="2.5"
              viewBox="0 0 24 24"
            >
          ...
          >
            ...
            <div class="flex items-center space-x-3 shrink-0">
              ...
              <div class="flex flex-col space-y-1.5">
                ...
                <button
                  @click="handleDeletePlayer(player._id, player.name)"
      ...
      >
        ...
        <button
          @click="navigateToHome('leaderboard')"
        ...
        <button
          class="flex flex-col items-center space-y-1 transition-all focus:outline-none text-lime-400 scale-105"
        >
          <!-- Users Icon -->
          <svg
            class="w-4.5 h-4.5"
        ...
        >
          ...
          <div class="px-5 space-y-4">
            ...
            <div class="space-y-1.5">
              ...
              <input
                v-model.number="addForm.initial_score"
                type="number"
                step="0.1"
                placeholder="6.0"
                class="w-full bg-slate-950 text-xs text-slate-200 px-3 py-2.5 rounded-xl border border-slate-800/80 placeholder-slate-650 focus:outline-none focus:border-lime-500/50"
        ...
        >
          ...
          <div class="px-5 space-y-4">
            ...
            <div class="space-y-1.5">
              <label class="text-[10px] uppercase font-bold text-slate-400 tracking-wider">Điểm Elo ban đầu</label>
              <input
                v-model.number="editForm.initial_score"
                type="number"
                step="0.1"
            ...
            <div class="space-y-1.5">
              ...
              <input
                v-model.number="editForm.current_score"
                type="number"
                step="0.01"
                class="w-full bg-slate-950 text-xs text-slate-200 px-3 py-2.5 rounded-xl border border-slate-800/80 focus:outline-none focus:border-lime-500/50"
              />
              <p class="text-[8px] text-slate-500">Cân nhắc kỹ trước khi chỉnh sửa Elo hiện tại để tránh làm lệch kết quả tính toán Elo hệ thống.</p>
            </div>
